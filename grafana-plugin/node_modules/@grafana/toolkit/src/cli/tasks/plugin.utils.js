...
const releaseNotes = () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    const { stdout } = yield execa(`awk 'BEGIN {FS="##"; RS="##"} FNR==3 {print "##" $1; exit}' CHANGELOG.md`, {
        shell: true,
    });
    return stdout;
});
const checkoutBranch = (branchName) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
...
const prepareRelease = ({ dryrun, verbose }) => (0, useSpinner_1.useSpinner)('Preparing release', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
...
const createRelease = ({ commitHash, githubUser, githubToken, gitRepoName }) => (0, useSpinner_1.useSpinner)('Creating release', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
...
const githubPublishRunner = ({ dryrun, verbose, commitHash }) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
