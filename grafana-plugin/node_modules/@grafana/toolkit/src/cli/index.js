...
const core_start_1 = require("./tasks/core.start");
...
const run = (includeInternalScripts = false) => {
    if (includeInternalScripts) {
        ...
        commander_1.program
            ...
            .action((cmd) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
            yield (0, execTask_1.execTask)(core_start_1.startTask)({
    ...
    commander_1.program.option('-v, --version', 'Toolkit version').action(() => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
